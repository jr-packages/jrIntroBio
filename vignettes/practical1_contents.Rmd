...
(1)  How many loci were located to the nucleus.
    ```{r}
    yeast_classes["NUC"]
    ```

(1) How many loci are in this data set?
    ```{r}
    sum(yeast_classes)
    ```

(1) What was the most common localisation in the dataset? __Note:__ You should use R and its functions to find this without having to look through the numbers.
    ```{r}
